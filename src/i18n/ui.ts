...
export const ui = {
	en: {
		...
		'areas.posts': 'Blog posts',
		'areas.noPosts': 'No posts written yet.',
		...
		'blog.title': 'Blog - Jon A. Martiarena',
		'blog.description': 'Posts by Jon A. Martiarena on electronics, QA and automation, web development and martial arts.',
		'blog.heading': 'Blog',
		'blog.intro': 'Some of my thoughts on various topics. Everything here is my own work.',
		'blog.filterLabel': 'Filter posts by area',
		'blog.showing': 'Showing {shown} of {total} posts',
		'blog.noPosts': 'No posts yet.',
		'blog.back': 'All posts',
		'blog.toc': 'Contents',

		'timer.legend': 'Settings',
		'timer.rounds': 'Rounds',
		'timer.work': 'Round length',
		'timer.rest': 'Rest',
		'timer.prepare': 'Get ready',
		...
		'timer.sound': 'Sound',
		'timer.ready': 'Ready',
		'timer.preparePhase': 'Get ready',
		'timer.workPhase': 'Round',
		'timer.restPhase': 'Rest',
		'timer.done': 'Finished',
		'timer.roundOf': 'Round {n} of {total}',
	...
	es: {
		...
		'areas.posts': 'Entradas del blog',
		'areas.noPosts': 'Todavía no hay entradas escritas.',
		...
		'blog.title': 'Blog - Jon A. Martiarena',
		'blog.description': 'Entradas de Jon A. Martiarena sobre electrónica, QA y automatización, desarrollo web y artes marciales.',
		'blog.heading': 'Blog',
		'blog.intro': 'Algunas reflexiones propias sobre diversos temas. Todo lo aquí expuesto es salido de mi puño y letra.',
		'blog.filterLabel': 'Filtrar entradas por área',
		'blog.showing': 'Mostrando {shown} de {total} entradas',
		'blog.noPosts': 'Todavía no hay entradas.',
		'blog.back': 'Todas las entradas',
		'blog.toc': 'Índice',

		'timer.legend': 'Ajustes',
		'timer.rounds': 'Asaltos',
		'timer.work': 'Duración del asalto',
		'timer.rest': 'Descanso',
		'timer.prepare': 'Preparación',
		...
		'timer.sound': 'Sonido',
		'timer.ready': 'Listo',
		'timer.preparePhase': 'Preparados',
		'timer.workPhase': 'Asalto',
		'timer.restPhase': 'Descanso',
		'timer.done': 'Terminado',
		'timer.roundOf': 'Asalto {n} de {total}',
